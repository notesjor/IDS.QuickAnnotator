...
namespace IDS.QuickAnnotator.Client.Forms
{
  public partial class DashboardForm : AbstractForm
  {
    ...
    public DashboardForm()
    {
      ...
      {
        "Ballet-Tänzern", "Ballett-Tänzer", "Ballett-Tänzerin", "Ballett-Tänzerinnen", "Ballett-Tänzers", "Balletttänzer", "Balletttänzerin", "Balletttänzerinnen", "Balletttänzern", "Balletttänzers", "Bauarbeiter", "Bauarbeiterin", "Bauarbeiterinnen", "Bauarbeitern", "Bauarbeiters", "Eiskunstläufer", "Eiskunstläuferin", "Eiskunstläuferinnen", "Eiskunstläufern", "Eiskunstläufers", "Elektriker", "Elektrikerin", "Elektrikerinnen", "Elektrikern", "Elektrikers", "Flugbegleiter", "Flugbegleiterin", "Flugbegleiterinnen", "Flugbegleitern", "Flugbegleiters", "Fußballspieler", "Fußballspielerin", "Fußballspielerinnen", "Fußballspielern", "Fußballspielers", "Geburtshelfer", "Geburtshelferin", "Geburtshelferinnen", "Geburtshelfern", "Geburtshelfers", "Haushälter", "Haushälterin", "Haushälterinnen", "Haushältern", "Haushälters", "Hellseher", "Hellseherin", "Hellseherinnen", "Hellsehern", "Hellsehers", "Kosmetiker", "Kosmetikerin", "Kosmetikerinnen", "Kosmetikern", "Kosmetikers", "Kranführer", "Kranführerin", "Kranführerinnen", "Kranführern", "Kranführers", "Maurer", "Maurerin", "Maurerinnen", "Maurern", "Maurers", "Pfleger", "Pflegerin", "Pflegerinnen", "Pflegern", "Pflegers", "Programmierer", "Programmiererin", "Programmiererinnen", "Programmierern", "Programmierers", "Rennfahrer", "Rennfahrerin", "Rennfahrerinnen", "Rennfahrern", "Rennfahrers", "Reporter", "Reporterin", "Reporterinnen", "Reportern", "Reporters", "Schneider", "Schneiderin", "Schneiderinnen", "Schneidern", "Schneiders", "Schreiner", "Schreinerin", "Schreinerinnen", "Schreinern", "Schreiners", "Verkäufer", "Verkäuferin", "Verkäuferinnen", "Verkäufern", "Verkäufers", "Wahrsager", "Wahrsagerin", "Wahrsagerinnen", "Wahrsagern", "Wahrsagers"
      };
      /*
      {
