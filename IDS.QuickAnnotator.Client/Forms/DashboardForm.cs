...
namespace IDS.QuickAnnotator.Client.Forms
{
  public partial class DashboardForm : AbstractForm
  {
    ...
    public DashboardForm()
    {
      ...
      _editor.Highlight = new HashSet<string>
      {
        "Sportler", "Sportlers", "Sportlern", "Sportlerin", "Sportlerinnen", "Musiker", "Musikers", "Musikern", "Musikerin", "Musikerinnen", "Bassist", "Bassisten", "Bassistin", "Bassistinnen", "Kletterer", "Kletterers", "Kletterern", "Kletterin", "Kletterinnen", "Künstler", "Künstlers", "Künstlern", "Künstlerin", "Künstlerinnen", "Surfer", "Surfers", "Surfern", "Surferin", "Surferinnen"
      };
